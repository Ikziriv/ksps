...
@section('content')
  ...
  @include('admin.partials.entete', ['title' => trans('back/ahliwaris.add'), 'icone' => 'user-plus', 'fil' => link_to('ahliwaris', trans('back/ahliwaris.heirs')) . ' / ' . trans('back/ahliwaris.add')])

<div class="row">
  <div class="col-sm-12">    

    {!! Form::open(['url' => 'ahliwaris', 'method' => 'post', 'class' => 'form-horizontal panel']) !!}
